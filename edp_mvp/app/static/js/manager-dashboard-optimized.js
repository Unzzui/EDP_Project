...
class ManagerDashboardOptimized {
    ...
    async forceRefresh() {
        ...
        try {
            ...
            const refreshUrl = this.cacheStatus.refreshUrl || `/manager/dashboard/refresh${currentUrl.search}`;
    ...
    async clearCache() {
        ...
        try {
            const response = await fetch('/manager/api/cache/clear?pattern=manager_dashboard:*');
            const result = await response.json();
    ...
    startTaskMonitoring() {
        ...
        this.refreshInterval = setInterval(async () => {
            try {
                const response = await fetch(`/manager/dashboard/status/${this.taskId}`);
                const result = await response.json();
    ...
    async refreshKPIs() {
        ...
        try {
            ...
            const currentUrl = new URL(window.location);
            const response = await fetch(`/manager/api/kpis${currentUrl.search}`);
            const result = await response.json();
    ...
    async getPerformanceMetrics() {
        try {
            const response = await fetch('/manager/api/performance/metrics');
            const result = await response.json();
    ...
    async getCacheStatus() {
        try {
            const response = await fetch('/manager/api/cache/status');
            const result = await response.json();
