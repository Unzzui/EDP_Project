...
@analytics_bp.route('/api/full-dashboard-data')
@login_required
...
@analytics_bp.route('/api/cache-status')
@login_required
...
@analytics_bp.route('/api/clear-cache', methods=['POST'])
@login_required
def clear_cache():
...
from .control_panel import update_edp_status, _procesar_actualizacion_estado

# Re-exportar con el mismo nombre para compatibilidad
analytics_bp.add_url_rule('/update_estado', 'update_edp_status', update_edp_status, methods=['POST']) 