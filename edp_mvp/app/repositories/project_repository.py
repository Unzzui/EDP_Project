...
class ProjectRepository(BaseRepository):
    ...
    def find_by_edp_id(self, edp_id: str) -> List[Project]:
        ...
        try:
            ...
            print(f"Error fetching projects for EDP {edp_id}: {e}")
            return []
    ...
    def find_by_status(self, status: str) -> List[Project]:
        ...
        try:
            ...
            print(f"Error fetching projects by status {status}: {e}")
            return []
    ...
    def find_by_date_range(self, start_date: datetime, end_date: datetime) -> List[Project]:
        ...
        try:
            ...
            print(f"Error fetching projects by date range: {e}")
            return []
    ...
    def update(self, project: Project) -> bool:
        ...
        try:
            ...
            print(f"Project {project.id} not found for update")
            return False
        except Exception as e:
    ...
    def delete(self, project_id: str) -> bool:
        ...
        try:
            ...
            print(f"Project {project_id} not found for deletion")
            return False
        except Exception as e:
